...
//        String cat = "cat";
//        System.out.println(cat.indexOf("z")); //prints -1
...
//        String good = "Good";
//        System.out.println(good.lastIndexOf("o")); // first index it finds STARTING FROM BACK
...
//        String firstName = name.substring(0, name.indexOf(" ")); //empty space starts where to omit
...
//        System.out.println(trimmedInput); //trim gets rid of \newlines as well
//
